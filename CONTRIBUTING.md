Contributing to QRAX Core
============================

The QRAX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/qrax-project/qrax/blob/master/doc/translation_process.md)
...
The following applies to code changes to the QRAX Core project, and is not to be
confused with overall QRAX Network Protocol consensus changes.

Whether a pull request is merged into QRAX Core rests with the project merge
...
Patches that change QRAX consensus rules are considerably more involved than
...
Where a patchset proposes to change the QRAX consensus, it must have been
...
The project leader is the release manager for each QRAX Core release.
