...
RESOURCES += src/qt/qrax.qrc src/qt/qrax_locale.qrc

TRANSLATIONS += src/qt/locale/qrax_bg.ts \
                src/qt/locale/qrax_de.ts \
                src/qt/locale/qrax_en.ts \
                src/qt/locale/qrax_es.ts \
                src/qt/locale/qrax_fi.ts \
                src/qt/locale/qrax_fr.ts \
                src/qt/locale/qrax_it.ts \
                src/qt/locale/qrax_ja.ts \
                src/qt/locale/qrax_pl.ts \
                src/qt/locale/qrax_pt.ts \
                src/qt/locale/qrax_ru.ts \
                src/qt/locale/qrax_sk.ts \
                src/qt/locale/qrax_sv.ts \
                src/qt/locale/qrax_vi.ts \
                src/qt/locale/qrax_zh_CN.ts \
                src/qt/locale/qrax_zh_TW.ts
