...
qrax.conf           | contains configuration settings for qraxd or qrax-qt
qraxd.pid           | stores the process id of qraxd while running
...
debug.log           | contains debug information and general logging generated by qraxd or qrax-qt
