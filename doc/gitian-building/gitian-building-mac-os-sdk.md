...
The script [extract-osx-sdk.sh](https://github.com/qrax-labs/qrax/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
qrax/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/qrax-labs/qrax/blob/master/doc/README_osx.md) for troubleshooting tips.
