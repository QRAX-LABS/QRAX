...
The build script we'll be using is contained in the QRAX github repository ([contrib/gitian-build.py](https://github.com/qrax-labs/qrax/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the QRAX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/QRAX-Labs/QRAX/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, qrax-detached-sigs, and qrax GitHub repos.
