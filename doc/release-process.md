...
- Detached signatures will then be committed to the [qrax-detached-sigs](https://github.com/qrax-Project/qrax-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
