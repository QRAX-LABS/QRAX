...
This document provides guidelines for internationalization of the QRAX Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to QRAX network</source>
        <translation>
	    <numerusform>%n active connection to QRAX network</numerusform>
	    <numerusform>%n active connections to QRAX network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qrax_en.ts` remains unchanged.
