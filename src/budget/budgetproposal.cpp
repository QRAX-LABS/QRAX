...
bool CBudgetProposal::CheckStartEnd()
{
    ...
    bool fNewRules = Params().GetConsensus().NetworkUpgradeActive(nBlockStart, Consensus::ACTIVATE_HUSH);
...
bool CBudgetProposal::UpdateValid(int nCurrentHeight)
{
    ...
    bool fNewRules = Params().GetConsensus().NetworkUpgradeActive(nCurrentHeight, Consensus::ACTIVATE_HUSH);
