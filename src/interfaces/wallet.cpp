...
namespace interfaces {
    ...
    AssetsBalance Wallet::getAssets() {
        AssetsBalance result;
        result.assets = m_wallet.GetMultiMiningBalance();
        result.structure = m_wallet.GetMultiMiningStructureBalance();
        result.percent = m_wallet.GetMultiMiningPercent();
        result.time = m_wallet.GetAssetNodeTime();
        result.profit = m_wallet.GetAssetPercentDowngradeProfit();
        return result;
    }
