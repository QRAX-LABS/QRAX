...
#ifndef QRAX_INTERFACES_WALLET_H
#define QRAX_INTERFACES_WALLET_H
...
struct AssetsBalance
{
    ...
    bool balanceChanged(const AssetsBalance &prev) const
    {
        return time != prev.time || assets != prev.assets || structure != prev.structure || percent != prev.percent || profit != prev.profit;
    }
};
...
#endif // QRAX_INTERFACES_WALLET_H
