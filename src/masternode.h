...
//
// The Masternode Class. It contains the input of the 10000 QRAX, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 50000 QRAX - checking if valid masternode)
