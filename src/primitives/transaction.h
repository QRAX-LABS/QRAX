...
public:
    ...
    bool IsMultiMiningMint() const;
    bool IsAssetDposMint() const;
...
public:
    ...
    CAmount GetTxFeeByAmount() const;
    ...
    bool HasAssetsMintOutputs() const;
    bool HasAssetsSpendInputs() const;
    bool HasAssetsDposMintOutputs() const;

    bool ContainsAssets() const
    {
        return HasAssetsSpendInputs() || HasAssetsMintOutputs() || HasAssetsDposMintOutputs();
    }

    bool IsCoinBase() const
    {
        return (vin.size() == 1 && vin[0].prevout.IsNull() && !HasAssetsMintOutputs() && !HasAssetsSpendInputs() && !HasAssetsDposMintOutputs());
    }
    ...
    CAmount GetMultiMiningSpend() const;
