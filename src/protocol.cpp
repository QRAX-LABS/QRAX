...
const char* ASSETADDRESS = "aadr";
const char* ASSETMNNOTIFY = "amnt";
const char* MMPROGRAM = "mmprogs";
const char* GETMMPROGRAMS = "getmmprogs";
...
static const char* ppszTypeName[] = {
    ...
    NetMsgType::ASSETADDRESS,
    NetMsgType::ASSETMNNOTIFY,
    NetMsgType::MMPROGRAM,
    NetMsgType::GETMMPROGRAMS,
    "mnq",
