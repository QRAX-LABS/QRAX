...
static bool AppInitRawTx(int argc, char* argv[])
{
	...
	std::string strUsage = _("QRAX Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
	                       "  qrax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qrax transaction") + "\n" +
	                       "  qrax-tx [options] -create [commands]   " + _("Create hex-encoded qrax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qrax transaction
