...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            QRAXGUI* window = static_cast<QRAXGUI*>(parentWidget());
...
{
    QRAXGUI* gui = static_cast<QRAXGUI*>(parentWidget());
...
{
    hide();
    static_cast<QRAXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("QRAX will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your QRAXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
