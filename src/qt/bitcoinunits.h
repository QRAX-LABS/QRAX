...
/** QRAX unit definitions. Encapsulates parsing and formatting
...
class AssetPercents : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AssetPercents(QObject* parent);
    ...
    static QList<Percent> availablePercents();
    static QString name(int p);
...
private:
    QList<AssetPercents::Percent> percentlist;
};
typedef AssetPercents::Percent AssetPercent;
