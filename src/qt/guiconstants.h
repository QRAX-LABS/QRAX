...
/* QRAX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "QRAX"
#define QAPP_ORG_DOMAIN "qrax.org"
#define QAPP_APP_NAME_DEFAULT "QRAX-Qt"
#define QAPP_APP_NAME_TESTNET "QRAX-Qt-testnet"
