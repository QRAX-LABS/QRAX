...
#include "qt/qrax/forms/ui_addresseswidget.h"
...
AddressesWidget::AddressesWidget(QRAXGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
		...
		bool isShielded = false; //walletModel->IsShieldedDestination(pivAdd);
