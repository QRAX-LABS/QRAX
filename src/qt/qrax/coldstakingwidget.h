...
#include "qt/qrax/sendmultirow.h"
#include "qt/qrax/coldstakingmodel.h"
#include "qt/qrax/contactsdropdown.h"
#include "qt/qrax/addressholder.h"
...
public:
    explicit ColdStakingWidget(QRAXGUI* parent);
    ~ColdStakingWidget();
