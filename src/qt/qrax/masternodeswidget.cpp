...
#include "qt/qrax/forms/ui_masternodeswidget.h"

#include "qt/qrax/qtutils.h"
#include "qt/qrax/mnrow.h"
#include "qt/qrax/mninfodialog.h"
#include "qt/qrax/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(QRAXGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= MASTERNODE_PAYMENT_AMOUNT) {
