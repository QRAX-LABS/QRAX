...
#include "qt/qrax/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/qrax/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("18966");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("18964");
    } else {
        ui->lineEditPort->setText("18962");
    }
