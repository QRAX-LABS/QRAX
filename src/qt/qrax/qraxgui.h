...
#ifndef QRAX_CORE_NEW_GUI_QRAXGUI_H
#define QRAX_CORE_NEW_GUI_QRAXGUI_H
...
#include "qt/qrax/settings/settingswidget.h"
#include "qt/qrax/settings/settingsfaqwidget.h"
#include "qt/rpcconsole.h"
#include "qt/assetrewardshistorytablemodel.h"
...
/**
  QRAX GUI main class. This class represents the main window of the QRAX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QRAXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QRAXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~QRAXGUI();
...
#endif //QRAX_CORE_NEW_GUI_QRAXGUI_H
