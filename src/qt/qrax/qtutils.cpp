...
void closeDialog(QDialog* widget, QRAXGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, QRAXGUI* gui, double posX, int posY)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackground(QDialog* widget, QRAXGUI* gui, double posX)
{
    return openDialogWithOpaqueBackgroundY(widget, gui, posX, 5);
}

bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, QRAXGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
...
void setFilterAddressBook(QComboBox* filter, SortEdit* lineEdit)
{
    ...
    filter->addItem(QObject::tr("Hush Recv"), AddressTableModel::ShieldedReceive);
    filter->addItem(QObject::tr("Hush Contact"), AddressTableModel::ShieldedSend);
}
...
void setSortTxTypeFilter(QComboBox* filter, SortEdit* lineEditType)
{
    ...
    /*filter->addItem(QObject::tr("Hush"),
                    TransactionFilterProxy::TYPE(TransactionRecord::RecvWithShieldedAddress) |
                    TransactionFilterProxy::TYPE(TransactionRecord::SendToShielded) |
    ...
    filter->addItem(QObject::tr("To yourself"), TransactionFilterProxy::TYPE(TransactionRecord::SendToSelf) |
                                            ...
                                            TransactionFilterProxy::TYPE(TransactionRecord::SendToSelfShieldToShieldChangeAddress) |
                                            TransactionFilterProxy::TYPE(TransactionRecord::SendToSelfShieldToTransparent));
    filter->addItem(QObject::tr("DPOS stakes"), TransactionFilterProxy::TYPE(TransactionRecord::StakeDelegated));
    ...
    filter->addItem(QObject::tr("Asset Reward"), TransactionFilterProxy::TYPE(TransactionRecord::AssetReward));
    filter->addItem(QObject::tr("DPOS Asset Reward"), TransactionFilterProxy::TYPE(TransactionRecord::DposAssetReward));
}
