...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, QRAXGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, QRAXGUI* gui, double posX = 3);
