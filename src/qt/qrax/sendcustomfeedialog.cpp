...
#include "qt/qrax/sendcustomfeedialog.h"
#include "qt/qrax/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(QRAXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &QRAXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
