...
#include "qt/qrax/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/qrax/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(QRAXGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &QRAXGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
