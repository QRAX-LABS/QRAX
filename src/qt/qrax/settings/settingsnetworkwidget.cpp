...
#include "qt/qrax/settings/settingsnetworkwidget.h"
#include "qt/qrax/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/qrax/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(QRAXGUI* _window, QWidget *parent) :
