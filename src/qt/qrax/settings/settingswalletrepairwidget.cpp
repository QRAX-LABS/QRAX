...
#include "qt/qrax/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/qrax/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(QRAXGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsWalletRepairWidget)
{
    ...
    ui->pushButtonUpgrade->hide();
    ui->labelMessageUpgrade->hide();
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to QRAXGUI::handleRestart()
