...
UniValue preparebudget(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 6)
        throw std::runtime_error(
			"preparebudget \"proposal-name\" \"url\" payment-count block-start \"qrax-address\" monthly-payment\n"
            ...
            "5. \"qrax-address\":   (string, required) QRAX address to send payments to\n"
            ...
            "\nExamples:\n" +
			HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.qrax.org/t/test-proposal\" 2 820800 \"QfmdnoFr17gBfLuLju4k16gPGHTXfexZnc\" 500") +
			HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.qrax.org/t/test-proposal\" 2 820800 \"QfmdnoFr17gBfLuLju4k16gPGHTXfexZnc\" 500"));
    ...
    if (!pwalletMain->CreateBudgetFeeTX(wtx, nHash, keyChange, false)) { // 100 QRAX collateral for proposal
...
UniValue submitbudget(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 7)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
			HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.qrax.org/t/test-proposal\" 2 820800 \"QfmdnoFr17gBfLuLju4k16gPGHTXfexZnc\" 500") +
			HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.qrax.org/t/test-proposal\" 2 820800 \"QfmdnoFr17gBfLuLju4k16gPGHTXfexZnc\" 500"));
...
UniValue getbudgetprojection(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) QRAX address of payment\n"
            "    \"Ratio\": x.xxx,               (numeric) Ratio of yeas vs nays\n"
            "    \"Yeas\": n,                    (numeric) Number of yea votes\n"
            "    \"Nays\": n,                    (numeric) Number of nay votes\n"
            "    \"Abstains\": n,                (numeric) Number of abstains\n"
            "    \"TotalPayment\": xxx.xxx,      (numeric) Total payment amount in QRAX\n"
            "    \"MonthlyPayment\": xxx.xxx,    (numeric) Monthly payment amount in QRAX\n"
            ...
            "    \"Allotted\": xxx.xxx,           (numeric) Amount of QRAX allotted in current period\n"
            "    \"TotalBudgetAllotted\": xxx.xxx (numeric) Total QRAX allotted\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
UniValue mnfinalbudget(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "show") {
        ...
        for (CFinalizedBudget* finalizedBudget : winningFbs) {
            ...
            //std::string strName = strprintf("%s", finalizedBudget->GetName(), nHash.ToString());
            resultObj.pushKV(nHash.ToString(), bObj);
        }
