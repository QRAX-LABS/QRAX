...
const char* GetOpName(opcodetype opcode)
{
    ...
    // multimining reward
    case OP_ASSETSSPEND      : return "OP_ASSETSSPEND";
    case OP_ASSETSMINT       : return "OP_ASSETSMINT";
    case OP_DPOSASSETSMINT   : return "OP_DPOSASSETSMINT";
...
bool CScript::IsPayAssetScriptHash() const
{
    return (this->size() == 26 &&
            (*this)[0] == OP_DUP &&
            (*this)[1] == OP_HASH160 &&
            (*this)[2] == OP_ASSETSMINT &&
            (*this)[24] == OP_EQUALVERIFY &&
            (*this)[25] == OP_CHECKSIG);
}

bool CScript::IsPayAssetDposScript() const
{
    return (this->size() == 51 &&
            (*this)[2] == OP_ROT &&
            (*this)[4] == OP_DPOSASSETSMINT &&
            (*this)[5] == 0x14 &&
            (*this)[27] == 0x14 &&
            (*this)[49] == OP_EQUALVERIFY &&
            (*this)[50] == OP_CHECKSIG);
...
bool CScript::IsPayToGenesisAddress(const std::string &genesis) const
{
    return false;
}

bool CScript::IsMultiMiningSpend() const
{
    return StartsWithOpcode(OP_ASSETSSPEND);
}
