...
#ifndef QRAX_STAKEINPUT_H
#define QRAX_STAKEINPUT_H
...
class CNewStake : public CStakeInput
{
private:
...
public:
	CNewStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) :
            CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

	static CNewStake* NewStake(const CTxIn& txin);
