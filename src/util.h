...
extern const char * const QRAX_CONF_FILENAME;
extern const char * const QRAX_PID_FILENAME;
extern const char * const QRAX_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("qrax-%s", name);
