...
static const bool DEFAULT_MULTIWALLETS  = false;
...
extern std::atomic<bool> fMultiMiningIsInit;
...
bool GetSupplyIndexByHeight(CAmount &amount, int nHeight = 0);
...
void UpdateCoins(const CTransaction& tx, CCoinsViewCache& inputs, int nHeight, bool fSkipInvalid = true);
...
/** Global variable that points to the multimining database (protected by cs_main) */
class CMultiMiningDB;
class CMultiMiningProgramDB;

extern CMultiMiningDB* multiMiningDB;
extern CMultiMiningProgramDB* mmProgramDB;
