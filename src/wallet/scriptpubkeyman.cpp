...
void ScriptPubKeyMan::DeriveNewChildKey(CWalletDB &batch, CKeyMetadata& metadata, CKey& secret, const uint8_t& changeType)
{
    ...
    CExtKey cointypeKey;           //key at m/purpose'/coin_type'  --> key at m/44'/1896'
    CExtKey accountKey;            //key at m/purpose'/coin_type'/account' ---> key at m/44'/1896'/account_num'
    CExtKey changeKey;             //key at m/purpose'/coin_type'/account'/change ---> key at m/44'/1896'/account_num'/change', external = 0' or internal = 1'.
    ...
    purposeKey.Derive(cointypeKey, 1896 | BIP32_HARDENED_KEY_LIMIT);
    ...
    do {
        ...
        // m/44'/1896'/account_num/change'/<n>'
        metadata.key_origin.path.push_back(44 | BIP32_HARDENED_KEY_LIMIT);
        metadata.key_origin.path.push_back(1896 | BIP32_HARDENED_KEY_LIMIT);
