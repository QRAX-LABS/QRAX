...
public:
    ...
    bool ReadAssetWalletIdentKey(CKeyID &keyId);
    bool WriteAssetWalletIdentKey(const CKeyID &keyId);
    bool WriteAssetParentWalletIdentKey(const CKeyID &key);
    bool ReadAssetParentWalletIdentKey(CKeyID &key);
    bool EraseInvalidParentWalletIdent();
