...
"""Verify that starting qrax with -h works as expected."""
import subprocess

from test_framework.test_framework import QraxTestFramework
from test_framework.util import assert_equal

class HelpTest(QraxTestFramework):
    ...
    def run_test(self):
	self.log.info("Start qrax with -? for help text")
	...
	self.log.info("Start qrax with -version for version information")
