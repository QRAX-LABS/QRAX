...
from test_framework.qrax_node import QraxTestNode
...
class QRAX_ColdStakingTest(QraxTestFramework):
    ...
    def init_test(self):
	    ...
	    self.test_nodes.append(QraxTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 QRAX from the pot)
