...
class ReorgStakeTest(QraxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        # verify that nodes have the expected QRAX supply
    ...
    def run_test(self):
        ...
        # Verify that QRAX supply was properly updated after the reorgs
        self.log.info("Check QRAX supply...")
