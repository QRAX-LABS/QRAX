...
class BudgetProposalTest(QraxTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Invalid block start", self.nodes[0].preparebudget,
				...
				self.log.info("Test with invalid QRAX address")
	assert_raises_rpc_error(-5, "Invalid QRAX address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 QRAX allowed" % invalid_amt, self.nodes[0].preparebudget,
