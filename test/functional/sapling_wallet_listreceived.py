...
class ListReceivedTest (QraxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 QRAX.
        ...
        # Send 1 QRAX to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 QRAX sending them all (fee is 0.1 QRAX)
        ...
        # Confirm transaction (2 QRAX from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 QRAX, send 0.6 QRAX + 0.05 QRAX fee
